...
export default function Header() {
    ...
    return (
        <nav className="p-5 border-b-2 flex flex-col items-center items-center  background-color: linear-gradient(175deg, #ff7e5f 0%, #00d2ff 100%)">
            <h1 className="py-4 px-4 font-bold text-3xl text-center  "> Decentralized Lottery </h1><br/> 
            ...
            <h3 className="py-4 px-4 font-bold text-3xl text-center blinking">Connect your wallet to get started - a random winner every 10 minutes for only 0.01 eth/avax</h3>
